...
function Dashboard() {
    ...
    //Funçao alterar dados gera numeros aleatorios de 1 a 101 arredondados pra baixo
    //para que a cada 5 segundos ele atualize com valores novos randomicamente
    useEffect(() => {
